...
| A2 | done ([PR #5](https://github.com/jv8-alt/voice-agent/pull/5)) | `apps/web`: thread, auto-submit voice controls, cancel/approval, basic typing | Done when component tests cover immediate voice submission, working, cancel, approval, and outcomes | medium | 400 |
