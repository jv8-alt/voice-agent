...
| C1 | done ([PR #4](https://github.com/jv8-alt/voice-agent/pull/4)) | `fixtures` and `packages/workspace-fixture`: isolated fixture leases | Done when tests prove source immutability, task isolation, and path containment | high | 350 |
