...
| T4 | in-progress | Plan revision for reviewed domain, replay, voice, identity, and disclosure gaps; `MIKADO.md` only | Done when all replacement decisions, failure modes, architecture, flows, dependencies, boundaries, and acceptance criteria are approved | medium | 220 |
