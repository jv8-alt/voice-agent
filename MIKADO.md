...
| B1 | done ([PR #4](https://github.com/jv8-alt/voice-agent/pull/4)) | `apps/task-api`: Fastify shell, config, errors, DI seams | Done when injection tests verify health and every pinned HTTP error | low | 300 |
